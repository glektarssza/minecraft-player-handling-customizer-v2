...
/**
 * A base custom exception for other custom exceptions to extend from.
 */
public abstract class BaseCustomException extends Exception {
     ...
     */
    protected BaseCustomException(@Nullable final String message) {
        super(message);
    }
     ...
     *        created.
     */
    protected BaseCustomException(@Nullable final Throwable cause) {
        super(cause);
    }
